...
class EntertainmentFragment : Fragment(R.layout.fragment_top_headlines_news) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.topHeadlineNewsEntertainment.observe(viewLifecycleOwner, Observer { response ->
            when(response) {
                is Resource.Success -> {
                    hideProgressBar()
                    response.data?.let { newsResponse ->
                        ...
                        isLastPage = viewModel.topHeadlinesPageEntertainmentPage == totalPages
                        if(isLastPage){
    ...
    val scrollListener = object : RecyclerView.OnScrollListener() {
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            if(shouldPaging){
                viewModel.getTopHeadlinesEntertainment("us" , "entertainment")
                isScrolling = false
            }
        }
